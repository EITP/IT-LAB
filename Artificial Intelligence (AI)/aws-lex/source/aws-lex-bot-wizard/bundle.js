...
var chatbot = {
  ...
  region: window.awsRegion ? awsRegion : 'ap-southeast-2',
...
function launchWidget(evt, widget) {
  ...
  if (widgetContainer && widgetContainer.length) {
    ...
    var message = "Hi, I am your virtual assistant."; //Initial Message
...
function includejQuery(callback) {
  if (window.jQuery) {
    ...
    var jquery_src = 'https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js';
